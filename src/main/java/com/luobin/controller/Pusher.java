...
public class Pusher {
    ...
    private static String appId = "wx54665c87e44350c4";
    private static String secret = "e6337871abcf907126f0d3e3d9aeb7ee";
    ...
    public static void push(){
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser("ownn16J7WxMoatsaBzmrzrKbgAuY")
                .templateId("M_I2UFKq8GcgFwgHpzCDcgZoNogLAeNs0zH7PMAYLZg")
                .build();
        // 配置你的信息
        ...
        if(JiNianRiUtils.getLianAi() % 365 == 0){
            beizhu = "今天是ct" + (JiNianRiUtils.getLianAi() / 365) + "周年纪念日！";
        }
